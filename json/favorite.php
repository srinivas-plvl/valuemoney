...
$favid=$_REQUEST['favid'];
		...
		$cat_sel= "SELECT * FROM sub_catgs WHERE  cat_ref ='".$catid."'  and subcat_name ='".$subid."' and status = '1'"; 
			...
			if($tagid==1)
				{	
                   //http://localhost/json/favorite.php?userid=14&tag=1				
					$fav_sel="SELECT a.user_mode as usertype , b.favid as favoriteid, b.fav_dob as favdob, b.prf_name as profilename, b.description, b.positives, b.negatives 
				...
				//http://localhost/json/favorite.php?userid=18&catid=a&subid=8&tag=2&dob=2010-10-01
					$favinsert=" Insert into favorites (favid,userid,prf_name,fav_dob,description,positives,negatives,date,status) values('','".$userid."','".$prfname."','".$dob."','".$desp."','".$pos."','".$neg."','".$curntdate."',1)";			 
