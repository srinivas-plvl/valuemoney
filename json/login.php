...
<?php
//http://localhost/cms/json/login.php?mail=suresh@tech-active.com&pass=admin&type=1
error_reporting(0);
...
//$user_sel="select * from  users where status=1 and user_id='".$user_id."'";
    ...
    $user_sel= "SELECT * FROM users WHERE  email ='".$mail."'  and password ='".$pass."' and user_type = '".$type."' and status = '1'";    
