...
<div id="login-wrapper" class="clearfix">
	...
	<?php echo  $status;?>
        <div class="main-col"> 
		<h4 style="color:red"><?php echo $this->session->flashdata('success');?></h4>  
            ...
            <div class="panel">
                ...
                <?php 
                    ...
                    <input type="text" id="login_name" name="login_name" placeholder='Username' />
            ...
            <div class="panel" style="display:none">
                ...
                <?php 
					...
					echo form_open('welcome/forgotpassword',$attributes); ?>
